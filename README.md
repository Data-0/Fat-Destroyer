This mod adds the option for the player to choose when to despawn low condition fat. You can use the settings menu to choose a % amount to start despawning at, going from 10% up to 80%. 
